...
public final class Register {
	...
	/**
	 * The register's data represented as a integer. Integer primary type is used to optimise further computations since in Java all
	 * computations are done on integers.
	 */
